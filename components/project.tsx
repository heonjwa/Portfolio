...
export default function Project({
  ...
  tags,
  imageUrl,
  repoUrl, // Add a new prop for the GitHub URL
}: ProjectProps) {
    ...
    >
      <a href={repoUrl} target="_blank" rel="noopener noreferrer">
        <section
          ...
          sm:pr-8 sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 sm:group-even:pl-8 sm:group-odd:pr-8 dark:bg-white/10 dark:hover:bg-white/20
          dark:text-white"
        >
